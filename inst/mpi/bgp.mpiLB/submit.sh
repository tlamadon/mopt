...
#$ -pe mpich 10 #  <- load the openmpi parallel env w/ 3 slots
...
mpirun -np 10 /data/uctpfos/R/x86_64-unknown-linux-gnu-library/2.15/snow/RMPISNOW -q < example.bgp.mpi.r > example.Rout
